...
CREATE TABLE `Nasabah` (
    ...
    `saldo_poin` DOUBLE NOT NULL DEFAULT 0,
...
-- AddForeignKey
ALTER TABLE `Setoran` ADD CONSTRAINT `Setoran_adminId_fkey` FOREIGN KEY (`adminId`) REFERENCES `Admin`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
