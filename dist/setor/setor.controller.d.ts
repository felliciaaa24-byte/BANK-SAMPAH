...
export declare class SetoranController {
    ...
    findOne(id: string): import(".prisma/client").Prisma.Prisma__SetoranClient<({
        nasabah: {
            id: number;
            userId: number;
            nama_nasabah: string;
    ...
    update(id: string, updateSetoranDto: UpdateSetoranDto): import(".prisma/client").Prisma.Prisma__SetoranClient<{
        jumlah: number;
        tanggal: Date;
        status: import(".prisma/client").$Enums.STATUS;
        id: number;
    ...
    remove(id: string): import(".prisma/client").Prisma.Prisma__SetoranClient<{
        jumlah: number;
        tanggal: Date;
        status: import(".prisma/client").$Enums.STATUS;
        id: number;
