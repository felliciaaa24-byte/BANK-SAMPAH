...
let HadiahController = class HadiahController {
    ...
    update(id, updateHadiahDto) {
        return this.hadiahService.update(+id, updateHadiahDto);
    }
    remove(id) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_hadiah_dto_1.UpdateHadiahDto]),
    __metadata("design:returntype", void 0)
...
exports.HadiahController = HadiahController = __decorate([
    (0, swagger_1.ApiTags)('Hadiah'),
    (0, common_1.Controller)('hadiah'),
